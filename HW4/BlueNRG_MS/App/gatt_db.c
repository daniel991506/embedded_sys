...
#define COPY_ACC_W2ST_CHAR_UUID(uuid_struct)           COPY_UUID_128(uuid_struct,0x00,0xE0,0xE0,0x00,0x00,0x01,0x11,0xe1,0xac,0x36,0x00,0x02,0xa5,0xd5,0xc5,0x1b)
...
uint16_t HWServW2STHandle, EnvironmentalCharHandle, AccGyroMagCharHandle, AccCharHandle;
...
void Write_Requset_CB(uint16_t handle){
	if(handle == AccCharHandle){
